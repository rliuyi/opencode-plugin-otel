...
| LLM output, task-to-subagent run lifecycle, and agent attribution | [Span output and agent lifecycle](./span-output-and-agent-lifecycle.md) | `src/handlers/message.ts`, `src/handlers/session.ts` |
